...
--
-- Host: localhost
-- Waktu pembuatan: 01 Bulan Mei 2023 pada 08.34
...
--
-- Database: `id20683960_lat_smarty`
--
CREATE DATABASE IF NOT EXISTS `lat_smarty` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `lat_smarty`;
...
INSERT INTO `t_barang` (`kode_barang`, `nama_barang`, `id_kategori`, `hrg_brng`, `jumlah`) VALUES
('Xp5 pro', 'Xiaomi Poco X5 Pro', 2, 3000, 2);
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabel kategori barang';

--
-- Dumping data untuk tabel `t_kategori_barang`
--

INSERT INTO `t_kategori_barang` (`id_kategori`, `kategori`) VALUES
(1, 'Smartphone'),
(2, 'Laptop'),
(3, 'TV'),
(4, 'AC'),
